...
INSERT INTO "user"("username", "password", "org_name", "background", "phone", "contact_name", "admin") VALUES('admin', 'adminadmin', 'Results Foundation', 'Grant-giving non-profit.', '651-123-4567', 'Blaire Molitor', TRUE);

INSERT INTO "user"("username", "password", "org_name", "background", "phone", "contact_name") VALUES('chester@bowl.com', 'chesterbowl', 'Chester Bowl', 'Year-round program providing fun outdoor activities for youth of all ages and from all socio-economic backgrounds.', '612-765-4321', 'Chester A. Bowl');
...
INSERT INTO "focus_area"("focus") VALUES('Education');
INSERT INTO "focus_area"("focus") VALUES('Health');
INSERT INTO "focus_area"("focus") VALUES('Mentorship');
INSERT INTO "focus_area"("focus") VALUES('Housing');
